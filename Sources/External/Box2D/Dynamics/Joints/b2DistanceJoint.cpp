...
void b2DistanceJoint::InitVelocityConstraints(const b2TimeStep& step)
{
	...
	b2_float32 cr1u = b2Cross(r1, m_u);
	b2_float32 cr2u = b2Cross(r2, m_u);
	b2_float32 invMass = b1->m_invMass + b1->m_invI * cr1u * cr1u + b2->m_invMass + b2->m_invI * cr2u * cr2u;
...
void b2DistanceJoint::SolveVelocityConstraints(const b2TimeStep& step)
{
	...
	b2_float32 Cdot = b2Dot(m_u, v2 - v1);
...
bool b2DistanceJoint::SolvePositionConstraints(b2_float32 baumgarte)
{
