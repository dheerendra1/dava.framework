...
void b2RopeJoint::InitVelocityConstraints(const b2TimeStep& step)
{
	...
	b2_float32 invMass = bA->m_invMass + bA->m_invI * crA * crA + bB->m_invMass + bB->m_invI * crB * crB;
...
void b2RopeJoint::SolveVelocityConstraints(const b2TimeStep& step)
{
	...
	b2_float32 C = m_length - m_maxLength;
	b2_float32 Cdot = b2Dot(m_u, vB - vA);
...
bool b2RopeJoint::SolvePositionConstraints(b2_float32 baumgarte)
{
