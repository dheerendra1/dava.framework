...
: b2Joint(def)
{
	...
	b2_float32 coordinate1, coordinate2;
...
void b2GearJoint::SolveVelocityConstraints(const b2TimeStep& step)
{
	...
	b2_float32 Cdot = m_J.Compute(	b1->m_linearVelocity, b1->m_angularVelocity,
...
bool b2GearJoint::SolvePositionConstraints(b2_float32 baumgarte)
{
	...
	b2_float32 C = m_constant - (coordinate1 + m_ratio * coordinate2);
...
b2_float32 b2GearJoint::GetReactionTorque(b2_float32 inv_dt) const
{
	...
	b2Vec2 P = m_impulse * m_J.linearB;
	b2_float32 L = m_impulse * m_J.angularB - b2Cross(r, P);
	return inv_dt * L;
}
