...
void b2WeldJoint::InitVelocityConstraints(const b2TimeStep& step)
{
	...
	b2_float32 mA = bA->m_invMass, mB = bB->m_invMass;
	b2_float32 iA = bA->m_invI, iB = bB->m_invI;
...
bool b2WeldJoint::SolvePositionConstraints(b2_float32 baumgarte)
{
	...
	b2_float32 C2 = bB->m_sweep.a - bA->m_sweep.a - m_referenceAngle;
